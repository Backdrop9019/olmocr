...
CONFIG_PATH="olmocr/train/configs/qwen3/qwen3_4b_olmocr_cosine.yaml"
SCRIPT_PATH="olmocr/train/train_qwen3.py"
BASE_OUTPUT_DIR="/home/kyungho/olmocr-qwen3/4b/olmocr-qwen3-4b"
...
# Print info
echo "=========================================="
echo "Starting Qwen3-VL 4B Training"
echo "=========================================="
